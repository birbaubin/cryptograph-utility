...
class MultiFGSM:
    ...
    def attack(self, adj, node_list, perturbation_rate):
        ...
        modified_features = self.features.copy()
        ...
        for target_node in tqdm(node_list):
            ...
            model = FGA(self.surrogate, nnodes=adj.shape[0], device=self.device, attack_features=False, attack_structure=True)
            model = model.to(self.device)
            model.attack(modified_features, modified_adj, self.labels, self.idx_train, target_node, n_perturbations)
